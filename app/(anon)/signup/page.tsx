				...
				<section className={regForm}>
					...
					<form>
						<div className="input-box">
							<label>이름</label>
							<input type="text" name="name" placeholder="아름" value="홍길동" readOnly />
						</div>
						<div className="input-box">
							<label>아이디</label>
						...
						<div className="input-box">
							<label>이메일</label>
							<input type="email" name="email" placeholder="이메일" value="demo@email.com" readOnly />
						</div>
						<div className="input-box">
							<label>비밀번호</label>
						...
						<div className="input-box">
							<label>비밀번호 확인</label>
							<input type="password" name="password1" placeholder="비밀번호 확인" value="password" readOnly />
						</div>
						<div className="input-box">
