			...
			<section className="d:flex flex-direction:column gap:5">
				<header className="n-list">
					...
					<div className="ml:3 d:flex">
						<Link href="categories/create" className="n-icon n-icon:add icon-bd:circle">
							추가
						</Link>
					</div>
				</header>
				<section className="n-frame">
					<header>
						<h1 className="d:none2">
							<span className="n-icon n-icon:view_list n-deco n-deco-gap:2">카테고리목록</span>
						</h1>
						<div>
					...
					<div className="d:flex ai:center justify-content:end mb:2">
						<label>
							<input type="checkbox" name="isPublic" className="n-toggle flex-grow:0" readOnly />
					...
					<table className="n-table">
						...
						<tbody>
							<tr className="vertical-align:middle">
								...
								<td className="text-align:start n-heading-truncate">카테고리A</td>
								<td className="w:0 md:w:2 overflow:hidden">3</td>
								<td>
									<span className="d:inline-flex align-items:center">
										<label>
											<span className="fs:7 d:none">공개</span>
											<input type="checkbox" name="isPublic" className="n-toggle flex-grow:0" checked readOnly />
										</label>
									</span>
								</td>
								<td>
									<Link href="#" className="n-icon n-icon:edit_square n-icon-color:base-6">수정</Link>
							...
							<tr className="vertical-align:middle">
								...
								<td className="text-align:start n-heading-truncate">카테고리B</td>
								<td className="w:0 md:w:2 overflow:hidden">1</td>
								<td>
									<span className="d:inline-flex align-items:center">
										<label>
