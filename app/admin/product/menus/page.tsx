			...
			<section className="d:flex flex-direction:column gap:5">
				<header className="n-list">
					...
					<div className="ml:3 d:flex">
						<Link href="menus/create" className="n-icon n-icon:add icon-bd:circle">
							추가
						</Link>
					</div>
				</header>
				...
				<section className="n-frame:1">
					<header>
						<h1 className="d:none2">
							<span className="n-icon n-icon:view_list n-deco n-deco-gap:2">메뉴목록</span>
						</h1>
						<div>
							...
							<tbody>
								<tr className="vertical-align:middle">
									...
									<td className="w:0 md:w:2 overflow:hidden">
										<Image src="/image/product/americano.png" alt="아메리카노" width={50} height={50} />
									</td>
									...
									<td>
										<span className="d:inline-flex align-items:center">
											<label className="n-icon n-icon:arrow_drop_down n-icon-size:2 n-btn mr:2">
												<input type="checkbox" className="d:none n-row-expander" />
												<span>상세보기</span>
											</label>
											<Link className="n-icon n-icon:edit_square n-icon-color:base-6" href="menus/1/edit">수정</Link>
											<button className="n-icon n-icon:delete n-icon-color:base-6">삭제</button>
										</span>
									</td>
								</tr>
								<RowEx />
								<tr className="vertical-align:middle">
									<td>2</td>
									<td className="w:0 md:w:2 overflow:hidden">
										<Image src="/image/product/cafe_latte.png" alt="카페라떼" width={50} height={50} />
									</td>
									<td className="text-align:start n-heading-truncate">
									...
									<td>
										<span className="d:inline-flex align-items:center">
											...
											<Link className="n-icon n-icon:edit_square n-icon-color:base-6" href="menus/2/edit">수정</Link>
											<button className="n-icon n-icon:delete n-icon-color:base-6">삭제</button>
										</span>
									</td>
								</tr>
